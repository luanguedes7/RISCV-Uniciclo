...
.L1: addi x16, x0, 1        # não executado
.L2: blt  x1, x2, .L3       # toma o branch
    bge  x1, x2, .L4       # não executado
.L3: addi x17, x0, 2        # x17 = 2
.L4: bltu x1, x2, .L5       # toma o branch
    bgeu x1, x2, .L6       # não executado
.L5: addi x18, x0, 3        # x18 = 3
.L6: jal  x19, .L7          # x19 = PC + 4
.L7: jalr x20, x19, 0       # x20 = PC + 4